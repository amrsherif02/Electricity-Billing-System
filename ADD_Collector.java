 ...
 * @author DELL
 */
public class ADD_Collector extends javax.swing.JFrame {

    /**
     * Creates new form ADD_Collector
     */
    public ADD_Collector() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add New Electricity Collector");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String covered_area= jTextField8.getText() ;
        ...
        Electricity_Collector c = new Electricity_Collector(name);
        
        c.setDOB(DOB);
        c.setCollector_ID(cid);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ADD_Collector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ADD_Collector().setVisible(true);
            }
        });
    }
